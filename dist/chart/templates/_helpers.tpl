...
*/}}
{{- define "webapp-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "webapp-operator.resourceName" -}}
{{- $fullname := include "webapp-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "webapp-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
